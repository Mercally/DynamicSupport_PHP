...
<h2><i class="fa fa-user-times"></i> Eliminar usuario </h2>
...
<?php
	echo '<a class="btn btn-primary" href="'.$dirUsuario.'Principal.php">Cancelar</a> ';
	echo ' <a class="btn btn-danger" href="'.$dirAdminBackend.'Delete_Usuario.php?IdUsuario='.$IdUsuario.'">Eliminar</a>';
 ?>
